...
А более слабые Критерии Готовности приводят к дополнительным рискам и задержкам! Всё это мы обсудим подробнее в главе 10 [_Критерии готовности_](chapter10).

_Критерии Готовности - это крайне важный инструмент управления переходом на LeSS, поскольку он влияет на масштаб организационных изменений_. Руководителям приходится идти на компромисс между строгими Критериями Готовности (приводящими к бóльшим изменениям, снижению риска и задержек), и слабыми Критериями Готовности (приводящими к меньшим изменениям, но повышенным рискам и задержкам). Ключевой вопрос: «Какой объём изменений может выдержать моя организация в текущий момент?»

#### 3. Структурируйте команды правильно
Каждая Команда несёт общую ответственность за достижение общей цели. Чтобы поддержать их успех, важно убедиться, что они правильно структурированы. Вот требования к начальной структуре команд:
- **выделенные** - каждый сотрудник - участник одной и только одной команды
- **стабильные** - состав участников команды редко изменяется
- **долгоживущие** - это не временная проектная команда; члены команды работают вместе _годы_
- **кросс-функциональные** - команда обладает всеми необходимыми функциональными навыками, чтобы сделать _готовую_ функциональность
...
Детальнее о каждом из этих свойств команды вы можете прочесть в главе 4 [_Строим Организацию Вокруг Ценности для Клиента_](chapter4).

Такая новая организационная структура подразумевает, что работники уходят из своих функциональных подразделений и на постоянной основе входят в состав новых кросс-функциональных команд. Функциональные подразделения нужно расформировать.
