...
Из определения продукта следуют границы перехода на LeSS, содержание Бэклога Продукта и кто будет подходящей кандидатурой на роль Владельца Продукта. Чем шире определение продукта, тем лучше, но оно должно быть достаточно практичным для старта.
...
_Влияние на масштабы организационных изменений делает Критерии Готовности крайне важным инструментом управления для перехода на LeSS_. Руководителям приходится идти на компромисс между строгими Критериями Готовности, приводящими к б*о*льшим организационным изменениям и снижению риска и задержек, и слабыми Критериями Готовности, приводящими к меньшим организационным изменениям и повышенным рискам и задержкам. Ключевой вопрос: «Какой объём изменений может выдержать моя организация в текущий момент?»
...
Почему бы не сохранить подотчетность людей руководителям функциональных подразделений? Дело в том, что это приводит к _конфликту лояльности_, который разрушает общую ответственность и сплоченность команды. Возможно, сейчас вы думаете: "Они
преувеличивают. В нашей компании это может сработать". Даже не надейтесь. Мы видели много попыток - так не работает. Просто не делайте этого. Вместо этого у всех членов команды должен быть один и тот же руководитель, перед которым в явном виде поставлена задача создать благоприятную среду для достижения командой успеха.
