...
Создание определения продукта включает в себя:
* Расширение определения продукта с помощью _расширяющих вопросов_, таких как "Что такое наш продукт по мнению наших клиентов?"
* Ограничение определения продукта посредством _ограничивающих вопросов_, таких как "Что практично с учётом текущего устройства нашей организации?"
* Поиск улучшений, позволяющих расширить определение продукта.

Подробнее о том, почему чем шире определение продукта, тем лучше, и о том, как создать определение продукта, речь пойдет в главе 7 _Продукт_.
...
````Чем лучше и строже Критерии Готовности, тем больше будут организационные изменения (упразднение групп, ролей, должностей, ...).````
