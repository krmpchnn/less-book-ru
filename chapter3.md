...
Однокомандный Скрам мало что говорит о переходе на Скрам, кроме необходимости
начать ”по книге”. Это не потому, что фанатики Скрама хотят заставить
...
Этот классический подход похож на последовательный, использующий “большие партии” подход в разработке программного обеспечения, в котором _изменение является исключением_, строго управляемым… _множественными_ комиссиями по контролю изменений.
...
- Отсутствие поддержки менеджмента ведёт к поведению жертв: “Мы ничего не можем сделать без поддержки нашего руководителя“.
