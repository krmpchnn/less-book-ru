...
Это касается также и курса подготовки "Certified LeSS Practitioner" (сертифицированный практик LeSS). Мы _действительно_ рекомендуем эти курсы, но для обучения, а _не_ для сертификации.
